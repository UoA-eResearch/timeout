...
yt-dlp --download-archive timeout_archive.log --write-info-json --output "%(title).100B [%(id)s].%(ext)s" --batch-file data/timeout_links.txt --paths timeout_videos

# Download supplements videos
yt-dlp --download-archive supplements_archive.log --write-info-json --output "%(title).100B [%(id)s].%(ext)s" --batch-file data/supplements_links.txt --paths supplements_videos
```
...
*Last updated: 2026-06-21 03:10:31 UTC*
...
*Last updated: 2026-06-21 21:52:24 UTC*
...
The supplements dataset was filtered to include only videos where `menopause=True` from YouTube, TikTok, Facebook, and Instagram (n=3490 videos).
...
|:------------|--------:|----------------:|-------------:|----------------:|
| tiktok      |    1217 |     4.87773e+06 |  1.3623e+08  |          229850 |
| youtube     |    1199 |     1.20792e+06 |  4.01085e+07 |           52692 |
| facebook    |    1067 |     0           |  1.84059e+08 |               0 |
| instagram   |       7 | 39970           |  0           |             509 |
