...
yt-dlp --download-archive timeout_archive.log --write-info-json --output "%(title).200B [%(id)s].%(ext)s" --batch-file data/timeout_links.txt --paths timeout_videos

# Download supplements videos
yt-dlp --download-archive supplements_archive.log --write-info-json --output "%(title).200B [%(id)s].%(ext)s" --batch-file data/supplements_links.txt --paths supplements_videos
```
...
*Last updated: 2026-06-10 03:09:20 UTC*
...
*Last updated: 2026-06-10 22:27:59 UTC*
...
The supplements dataset was filtered to include only videos where `menopause=True` from YouTube, TikTok, Facebook, and Instagram (n=2660 videos).
...
|:------------|--------:|--------------:|-------------:|----------------:|
| tiktok      |    1058 |   4.06698e+06 |  1.23261e+08 |          172713 |
| youtube     |     817 |   1.02007e+06 |  3.32322e+07 |           44401 |
| facebook    |     782 |   0           |  1.21677e+08 |               0 |
